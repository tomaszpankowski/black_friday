...
class LoginForm extends Component{
    ...
    render(){
        return(        
            <Container fluid className={"align-items-center minh-100vh p-0 py-5 d-flex "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={5} lg={4} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-danger p-4 rounded bg-dark shadow text-danger opacity-9 fw-bold"
                            autoComplete="off"
                            method="POST">
                            ...
                            <Form.Group controlId="formLogin">
                                <Form.Label>Login</Form.Label>
                                 <Form.Control type="text" 
                                    ...
                                    className="rounded-pill border-danger text-secondary"
                                    maxLength="50"
                                    name="userName"
                            ...
                            <div className="w-100 text-start py-3">
                                <p className="text-danger fw-normal">
                                    Not registered? 
                                    <Link to={this.props.backLink.href} className="text-danger fw-bold text-decoration-none">
