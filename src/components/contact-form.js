            ...
            <Container fluid className={"contact-s2 align-items-center p-0 py-5 border-top border-danger d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={11} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-danger p-4 rounded bg-dark opacity-9 shadow text-danger fw-bold"
                            autoComplete="off"
                            method="POST">
                            ...
                            <Form.Group controlId="formFirstName">
                                ...
                                <Form.Control type="text"
                                    ...
                                    className="rounded-pill bg-dark border-danger text-white opacity-8"
                                    maxLength="50"
                                    name="firstName"
                            ...
                            <Form.Group controlId="formMessage" className="mt-3">
                                ...
                                <Form.Control as="textarea"
                                    rows={4}
                                    className="bg-dark border-danger text-white opacity-8"
                                    maxLength="250"
                                    name="messageText"
                                    onChange={this.updateFormData.bind(this)} 
                            ...
                            <div className="w-100 text-end mt-3">
                                <Button variant="outline-light"
                                    ...
                                    className="mx-1 rounded-pill border-danger text-danger">
                                    Clear
                                </Button>
                                <Button
